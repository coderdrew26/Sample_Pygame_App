...
YELLOW_SPACESHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'spaceship_yellow_2.png'))
...
RED_SPACEHIP_IMAGE = pygame.image.load(os.path.join('Assets', 'spaceship_red_2.png'))
RED_SPACEHIP = pygame.transform.rotate(pygame.transform.scale(RED_SPACEHIP_IMAGE, (SPACESHIP_WIDTH, SPACESHIP_HEIGHT)), 90)
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
    ...
    WIN.blit(RED_SPACEHIP, (red.x, red.y))
